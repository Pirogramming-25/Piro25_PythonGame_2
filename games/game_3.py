...
from common import is_user
# 팀 전체 헬퍼 함수 모아두는 common.py가 필요할듯 함. (실제 사용자와 컴퓨터 구별하는 함수 등등...)
...
CATEGORY_WORDS = {
    ...
    "목": set("""
        ...
        전나무 밤나무 감나무 벚나무 사과나무 배나무 복숭아나무
...
if __name__ == "__main__":
    # 테스트 실행 시 임시로 사용자 이름을 설정해야 is_user()가 동작함
    from common import set_user

    set_user("사용자")
    play("사용자", ["컴퓨터1", "컴퓨터2", "컴퓨터3"])
